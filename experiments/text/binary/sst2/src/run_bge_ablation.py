...
from metrics import confusion_matrix_payload, evaluate_model_selection
...
def main() -> None:
    ...
    for idx, variant_cfg in enumerate(config["variants"], start=1):
        ...
        summary = evaluate_model_selection(
            train_x,
            train_labels,
            val_x,
            val_labels,
